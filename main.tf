...
resource "aws_subnet" "public" {
  ...
  cidr_block              = cidrsubnet(aws_vpc.vpc.cidr_block, var.num_zones, count.index)
...
resource "aws_subnet" "private" {
  count             = var.num_zones
  availability_zone = data.aws_availability_zones.available.names[count.index]
  cidr_block        = cidrsubnet(aws_vpc.vpc.cidr_block, var.num_zones, var.num_zones + count.index)
  vpc_id            = aws_vpc.vpc.id
  tags = {
